export const tourData = [
    ...
    {   // Ilan Rodriguez commented
        id: 2,
        city: "Haverstraw, New York",
        img: "./img/letchworth.jpeg",
        name: "Letchworth Village Asylum",
        info:
        "Letchworth opened in the early 20th century to care for mentally handicapped individuals. It is a residential institution and hopsital to provide self-sufficiency the physically and mentally disabled of all ages. The facility eventually closed for good in 1996, and its buildings slipped into disrepair—becoming a ghost town. Many have died to abuse, malnutrition, and neglect in this instituation. In result, a cemetery filled with graves mark the remains of the dead of Letchworth Village. A memorial stone bears the inscription “THOSE WHO SHALL NOT BE FORGOTTEN” and lists hundreds of names. Grave markers bear only serial numbers assigned to the dead."
    },
    {
        id: 3,
